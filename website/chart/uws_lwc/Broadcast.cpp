...
int main() {
    ...
    us_timer_set(delayTimer, [](struct us_timer_t */*t*/) {
        ...
        char millis[] = "t:20180101,o:55.09,h:52.03,l:30.00,c:45.00,v:100";
        //std::cout << "Broadcasting timestamp: " << millis << std::endl;
	size_t len = strlen(millis);

        globalApp->publish("xxxx", std::string_view((char *) millis, len), uWS::OpCode::BINARY, false);
