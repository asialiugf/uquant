 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status getBars(::grpc::ClientContext* context, const ::uquantapi::kBarRequest& request, ::uquantapi::kBarReply* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::uquantapi::kBarReply>> AsyncgetBars(::grpc::ClientContext* context, const ::uquantapi::kBarRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::uquantapi::kBarReply>>(AsyncgetBarsRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::uquantapi::kBarReply>> PrepareAsyncgetBars(::grpc::ClientContext* context, const ::uquantapi::kBarRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::uquantapi::kBarReply>>(PrepareAsyncgetBarsRaw(context, request, cq));
    }
  private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::uquantapi::kBarReply>* AsyncgetBarsRaw(::grpc::ClientContext* context, const ::uquantapi::kBarRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::uquantapi::kBarReply>* PrepareAsyncgetBarsRaw(::grpc::ClientContext* context, const ::uquantapi::kBarRequest& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status getBars(::grpc::ClientContext* context, const ::uquantapi::kBarRequest& request, ::uquantapi::kBarReply* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::uquantapi::kBarReply>> AsyncgetBars(::grpc::ClientContext* context, const ::uquantapi::kBarRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::uquantapi::kBarReply>>(AsyncgetBarsRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::uquantapi::kBarReply>> PrepareAsyncgetBars(::grpc::ClientContext* context, const ::uquantapi::kBarRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::uquantapi::kBarReply>>(PrepareAsyncgetBarsRaw(context, request, cq));
    }
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::uquantapi::kBarReply>* AsyncgetBarsRaw(::grpc::ClientContext* context, const ::uquantapi::kBarRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::uquantapi::kBarReply>* PrepareAsyncgetBarsRaw(::grpc::ClientContext* context, const ::uquantapi::kBarRequest& request, ::grpc::CompletionQueue* cq) override;
    const ::grpc::internal::RpcMethod rpcmethod_SayHello_;
    const ::grpc::internal::RpcMethod rpcmethod_SayHelloAgain_;
    const ::grpc::internal::RpcMethod rpcmethod_getBars_;
  };
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status getBars(::grpc::ServerContext* context, const ::uquantapi::kBarRequest* request, ::uquantapi::kBarReply* response);
  };
  ...
  template <class BaseClass>
  class WithAsyncMethod_getBars : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithAsyncMethod_getBars() {
      ::grpc::Service::MarkMethodAsync(2);
    }
    ~WithAsyncMethod_getBars() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status getBars(::grpc::ServerContext* context, const ::uquantapi::kBarRequest* request, ::uquantapi::kBarReply* response) final override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestgetBars(::grpc::ServerContext* context, ::uquantapi::kBarRequest* request, ::grpc::ServerAsyncResponseWriter< ::uquantapi::kBarReply>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(2, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  typedef WithAsyncMethod_SayHello<WithAsyncMethod_SayHelloAgain<WithAsyncMethod_getBars<Service > > > AsyncService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithGenericMethod_getBars : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithGenericMethod_getBars() {
      ::grpc::Service::MarkMethodGeneric(2);
    }
    ~WithGenericMethod_getBars() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status getBars(::grpc::ServerContext* context, const ::uquantapi::kBarRequest* request, ::uquantapi::kBarReply* response) final override {
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_getBars : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithStreamedUnaryMethod_getBars() {
      ::grpc::Service::MarkMethodStreamed(2,
        new ::grpc::internal::StreamedUnaryHandler< ::uquantapi::kBarRequest, ::uquantapi::kBarReply>(std::bind(&WithStreamedUnaryMethod_getBars<BaseClass>::StreamedgetBars, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ~WithStreamedUnaryMethod_getBars() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status getBars(::grpc::ServerContext* context, const ::uquantapi::kBarRequest* request, ::uquantapi::kBarReply* response) final override {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedgetBars(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::uquantapi::kBarRequest,::uquantapi::kBarReply>* server_unary_streamer) = 0;
  };
  typedef WithStreamedUnaryMethod_SayHello<WithStreamedUnaryMethod_SayHelloAgain<WithStreamedUnaryMethod_getBars<Service > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_SayHello<WithStreamedUnaryMethod_SayHelloAgain<WithStreamedUnaryMethod_getBars<Service > > > StreamedService;
};
// class
...
class FutureApi final {
 public:
  ...
  typedef WithAsyncMethod_getBars<Service > AsyncService;
  template <class BaseClass>
  class WithGenericMethod_getBars : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
  ...
  typedef WithStreamedUnaryMethod_getBars<Service > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_getBars<Service > StreamedService;
};
