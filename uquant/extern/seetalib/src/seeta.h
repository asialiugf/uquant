...
*/
int SEE_MA(int start, int finish, const double in[], int N, double out[]); /* out index and in index must be the same */
...
int SEE_LMA(int start, int finish, const double in[], char F, int N, int M, double out[]);
