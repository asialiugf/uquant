...
void CTraderSpi::OnRspAuthenticate(CThostFtdcRspAuthenticateField *pRspAuthenticateField, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                   bool bIsLast) {
    ...
    if (pRspInfo) {
        uBEE::gb18030_to_utf8(pRspInfo->ErrorMsg, ErrMsg1, 1024);
        printf("\tErrorMsg [%s]\n", ErrMsg1);
        printf("\tErrorID [%d]\n", pRspInfo->ErrorID);
    }
    printf("\tnRequestID [%d]\n", nRequestID);
...
void CTraderSpi::OnRspUserLogin(CThostFtdcRspUserLoginField *pRspUserLogin, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                bool bIsLast) {
    ...
    if (pRspInfo) {
        uBEE::gb18030_to_utf8(pRspInfo->ErrorMsg, ErrMsg1, 1024);
        printf("\tErrorMsg [%s]\n", ErrMsg1);
        // uBEE::ErrLog(1000, "ErrorMsg", 1, pRspInfo->ErrorMsg, strlen(pRspInfo->ErrorMsg));
        printf("\tErrorID [%d]\n", pRspInfo->ErrorID);
    }
    printf("\tnRequestID [%d]\n", nRequestID);
    printf("\tbIsLast [%d]\n", bIsLast);
...
void CTraderSpi::OnRspUserPasswordUpdate(CThostFtdcUserPasswordUpdateField *pUserPasswordUpdate, CThostFtdcRspInfoField *pRspInfo,
...
void CTraderSpi::OnRspTradingAccountPasswordUpdate(CThostFtdcTradingAccountPasswordUpdateField *pTradingAccountPasswordUpdate,
...
void CTraderSpi::OnRspUserAuthMethod(CThostFtdcRspUserAuthMethodField *pRspUserAuthMethod, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                     bool bIsLast) {
...
void CTraderSpi::OnRspGenUserCaptcha(CThostFtdcRspGenUserCaptchaField *pRspGenUserCaptcha, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                     bool bIsLast) {
...
void CTraderSpi::OnRspGenUserText(CThostFtdcRspGenUserTextField *pRspGenUserText, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                  bool bIsLast) {
...
void CTraderSpi::OnRspOrderInsert(CThostFtdcInputOrderField *pInputOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    ...
    if (pInputOrder) {
        printf("\tBrokerID [%s]", pInputOrder->BrokerID);
        printf("\tInvestorID [%s]", pInputOrder->InvestorID);
        printf("\treserve1 [%s]", pInputOrder->reserve1);
        printf("\tOrderRef [%s]", pInputOrder->OrderRef);
        printf("\tUserID [%s]", pInputOrder->UserID);
...
void CTraderSpi::OnRspParkedOrderInsert(CThostFtdcParkedOrderField *pParkedOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                        bool bIsLast) {
    ...
    if (pParkedOrder) {
        ...
        uBEE::gb18030_to_utf8(pParkedOrder->ErrorMsg, ErrMsg1, 1024);
        printf("\tErrorMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnRspParkedOrderAction(CThostFtdcParkedOrderActionField *pParkedOrderAction, CThostFtdcRspInfoField *pRspInfo,
                                        int nRequestID, bool bIsLast) {
    ...
    if (pParkedOrderAction) {
        ...
        uBEE::gb18030_to_utf8(pParkedOrderAction->ErrorMsg, ErrMsg1, 1024);
        printf("\tErrorMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnRspOrderAction(CThostFtdcInputOrderActionField *pInputOrderAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                  bool bIsLast) {
...
void CTraderSpi::OnRspQryMaxOrderVolume(CThostFtdcQryMaxOrderVolumeField *pQryMaxOrderVolume, CThostFtdcRspInfoField *pRspInfo,
                                        int nRequestID, bool bIsLast) {
    printf("<OnRspQryMaxOrderVolume>\n");
...
void CTraderSpi::OnRspSettlementInfoConfirm(CThostFtdcSettlementInfoConfirmField *pSettlementInfoConfirm, CThostFtdcRspInfoField *pRspInfo,
                                            int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspRemoveParkedOrder(CThostFtdcRemoveParkedOrderField *pRemoveParkedOrder, CThostFtdcRspInfoField *pRspInfo,
                                        int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspRemoveParkedOrderAction(CThostFtdcRemoveParkedOrderActionField *pRemoveParkedOrderAction,
                                              CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspExecOrderInsert(CThostFtdcInputExecOrderField *pInputExecOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                      bool bIsLast) {
...
void CTraderSpi::OnRspExecOrderAction(CThostFtdcInputExecOrderActionField *pInputExecOrderAction, CThostFtdcRspInfoField *pRspInfo,
                                      int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspForQuoteInsert(CThostFtdcInputForQuoteField *pInputForQuote, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                     bool bIsLast) {
...
void CTraderSpi::OnRspQuoteAction(CThostFtdcInputQuoteActionField *pInputQuoteAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                  bool bIsLast) {
...
void CTraderSpi::OnRspBatchOrderAction(CThostFtdcInputBatchOrderActionField *pInputBatchOrderAction, CThostFtdcRspInfoField *pRspInfo,
                                       int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspOptionSelfCloseInsert(CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose, CThostFtdcRspInfoField *pRspInfo,
                                            int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspOptionSelfCloseAction(CThostFtdcInputOptionSelfCloseActionField *pInputOptionSelfCloseAction,
                                            CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspCombActionInsert(CThostFtdcInputCombActionField *pInputCombAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                       bool bIsLast) {
...
void CTraderSpi::OnRspQryOrder(CThostFtdcOrderField *pOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    ...
    if (pOrder) {
        printf("\tBrokerID [%s]", pOrder->BrokerID);
        printf("\tInvestorID [%s]", pOrder->InvestorID);
        // printf("\treserve1 [%s]", pOrder->reserve1);
        // printf("\tOrderRef [%s]", pOrder->OrderRef);
        printf("\tUserID [%s]", pOrder->UserID);
        // printf("\tCombOffsetFlag [%s]", pOrder->CombOffsetFlag);
        // printf("\tCombHedgeFlag [%s]", pOrder->CombHedgeFlag);
        // printf("\tGTDDate [%s]", pOrder->GTDDate);
        // printf("\tBusinessUnit [%s]", pOrder->BusinessUnit);
        // printf("\tOrderLocalID [%s]", pOrder->OrderLocalID);
        // printf("\tExchangeID [%s]", pOrder->ExchangeID);
        // printf("\tParticipantID [%s]", pOrder->ParticipantID);
        // printf("\tClientID [%s]", pOrder->ClientID);
        // printf("\treserve2 [%s]", pOrder->reserve2);
        // printf("\tTraderID [%s]", pOrder->TraderID);
        printf("\tTradingDay [%s]", pOrder->TradingDay);
        // printf("\tOrderSysID [%s]", pOrder->OrderSysID);
        // printf("\tInsertDate [%s]", pOrder->InsertDate);
        printf("\tInsertTime [%s]", pOrder->InsertTime);
        // printf("\tActiveTime [%s]", pOrder->ActiveTime);
        // printf("\tSuspendTime [%s]", pOrder->SuspendTime);
        // printf("\tUpdateTime [%s]", pOrder->UpdateTime);
        // printf("\tCancelTime [%s]", pOrder->CancelTime);
        // printf("\tActiveTraderID [%s]", pOrder->ActiveTraderID);
        // printf("\tClearingPartID [%s]", pOrder->ClearingPartID);
        // printf("\tUserProductInfo [%s]", pOrder->UserProductInfo);
        uBEE::gb18030_to_utf8(pOrder->StatusMsg, ErrMsg1, 1024);
        printf("\tStatusMsg [%s]", ErrMsg1);
        // //  printf("\tStatusMsg [%s]", pOrder->StatusMsg);
        // printf("\tActiveUserID [%s]", pOrder->ActiveUserID);
        // printf("\tRelativeOrderSysID [%s]", pOrder->RelativeOrderSysID);
        // printf("\tBranchID [%s]", pOrder->BranchID);
        // printf("\tInvestUnitID [%s]", pOrder->InvestUnitID);
        // printf("\tAccountID [%s]", pOrder->AccountID);
        // printf("\tCurrencyID [%s]", pOrder->CurrencyID);
        // printf("\treserve3 [%s]", pOrder->reserve3);
        // printf("\tMacAddress [%s]", pOrder->MacAddress);
        // printf("\tInstrumentID [%s]", pOrder->InstrumentID);
        printf("\t [%s]", pOrder->InstrumentID);
        // printf("\tExchangeInstID [%s]", pOrder->ExchangeInstID);
        // printf("\tIPAddress [%s]", pOrder->IPAddress);
        // printf("\tVolumeTotalOriginal [%d]", pOrder->VolumeTotalOriginal);
        // printf("\tMinVolume [%d]", pOrder->MinVolume);
        // printf("\tIsAutoSuspend [%d]", pOrder->IsAutoSuspend);
        // printf("\tRequestID [%d]", pOrder->RequestID);
        // printf("\tInstallID [%d]", pOrder->InstallID);
        // printf("\tNotifySequence [%d]", pOrder->NotifySequence);
        // printf("\tSettlementID [%d]", pOrder->SettlementID);
        // printf("\tVolumeTraded [%d]", pOrder->VolumeTraded);
        // printf("\tVolumeTotal [%d]", pOrder->VolumeTotal);
        // printf("\tSequenceNo [%d]", pOrder->SequenceNo);
        // printf("\tFrontID [%d]", pOrder->FrontID);
        // printf("\tSessionID [%d]", pOrder->SessionID);
        // printf("\tUserForceClose [%d]", pOrder->UserForceClose);
        // printf("\tBrokerOrderSeq [%d]", pOrder->BrokerOrderSeq);
        // printf("\tZCETotalTradedVolume [%d]", pOrder->ZCETotalTradedVolume);
        // printf("\tIsSwapOrder [%d]", pOrder->IsSwapOrder);
        // printf("\tOrderPriceType [%c]", pOrder->OrderPriceType);
        // printf("\tDirection [%c]", pOrder->Direction);
        // printf("\tTimeCondition [%c]", pOrder->TimeCondition);
        // printf("\tVolumeCondition [%c]", pOrder->VolumeCondition);
        // printf("\tContingentCondition [%c]", pOrder->ContingentCondition);
        // printf("\tForceCloseReason [%c]", pOrder->ForceCloseReason);
        printf("\tOrderSubmitStatus [%c]", pOrder->OrderSubmitStatus);
        // printf("\tOrderSource [%c]", pOrder->OrderSource);
        printf("\tOrderStatus [%c]", pOrder->OrderStatus);
        printf("\tOrderType [%c]", pOrder->OrderType);
        printf("\tLimitPrice [%.2lf]", pOrder->LimitPrice);
        // printf("\tStopPrice [%.8lf]\n", pOrder->StopPrice);
        /*
        ...
        if (OrderCount == 3) {
            printf("\t 在队列中未成交的笔数超过10笔，请注意交易风险！");
        }
        */
    }
    if (pRspInfo) {
...
void CTraderSpi::OnRspQryInvestorPosition(CThostFtdcInvestorPositionField *pInvestorPosition, CThostFtdcRspInfoField *pRspInfo,
                                          int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQryTradingAccount(CThostFtdcTradingAccountField *pTradingAccount, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                        bool bIsLast) {
...
void CTraderSpi::OnRspQryTradingCode(CThostFtdcTradingCodeField *pTradingCode, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                     bool bIsLast) {
...
void CTraderSpi::OnRspQryInstrumentMarginRate(CThostFtdcInstrumentMarginRateField *pInstrumentMarginRate, CThostFtdcRspInfoField *pRspInfo,
                                              int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQryProduct(CThostFtdcProductField *pProduct, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    ...
    if (pProduct) {
        ...
        printf("\tOpenLimitControlLevel [%c]\n", pProduct->OpenLimitControlLevel);
        printf("\tOrderFreqControlLevel [%c]\n", pProduct->OrderFreqControlLevel);
...
void CTraderSpi::OnRspQryDepthMarketData(CThostFtdcDepthMarketDataField *pDepthMarketData, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
    ...
    if (pDepthMarketData) {
        printf("[%s]", pDepthMarketData->InstrumentID);
        ...
        // printf("\tExchangeInstID [%s]", pDepthMarketData->ExchangeInstID);
        printf("\tVolume[%d]", pDepthMarketData->Volume);
        printf("\tLastPrice[%.2lf]\n", pDepthMarketData->LastPrice);
        /*
...
void CTraderSpi::OnRspQryTraderOffer(CThostFtdcTraderOfferField *pTraderOffer, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                     bool bIsLast) {
    printf("<OnRspQryTraderOffer>\n");
    if (pTraderOffer) {
...
void CTraderSpi::OnRspQrySettlementInfo(CThostFtdcSettlementInfoField *pSettlementInfo, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                        bool bIsLast) {
...
void CTraderSpi::OnRspQryTransferBank(CThostFtdcTransferBankField *pTransferBank, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                      bool bIsLast) {
...
void CTraderSpi::OnRspQryInvestorPositionCombineDetail(CThostFtdcInvestorPositionCombineDetailField *pInvestorPositionCombineDetail,
                                                       CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQryCFMMCTradingAccountKey(CThostFtdcCFMMCTradingAccountKeyField *pCFMMCTradingAccountKey,
                                                CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQryEWarrantOffset(CThostFtdcEWarrantOffsetField *pEWarrantOffset, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                        bool bIsLast) {
...
void CTraderSpi::OnRspQryInvestorProductGroupMargin(CThostFtdcInvestorProductGroupMarginField *pInvestorProductGroupMargin,
                                                    CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQryExchangeMarginRate(CThostFtdcExchangeMarginRateField *pExchangeMarginRate, CThostFtdcRspInfoField *pRspInfo,
                                            int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQryExchangeMarginRateAdjust(CThostFtdcExchangeMarginRateAdjustField *pExchangeMarginRateAdjust,
                                                  CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQryExchangeRate(CThostFtdcExchangeRateField *pExchangeRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                      bool bIsLast) {
...
void CTraderSpi::OnRspQrySecAgentACIDMap(CThostFtdcSecAgentACIDMapField *pSecAgentACIDMap, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                         bool bIsLast) {
...
void CTraderSpi::OnRspQryProductExchRate(CThostFtdcProductExchRateField *pProductExchRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                         bool bIsLast) {
...
void CTraderSpi::OnRspQryProductGroup(CThostFtdcProductGroupField *pProductGroup, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                      bool bIsLast) {
...
void CTraderSpi::OnRspQryMMInstrumentCommissionRate(CThostFtdcMMInstrumentCommissionRateField *pMMInstrumentCommissionRate,
                                                    CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQryMMOptionInstrCommRate(CThostFtdcMMOptionInstrCommRateField *pMMOptionInstrCommRate,
                                               CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQryInstrumentOrderCommRate(CThostFtdcInstrumentOrderCommRateField *pInstrumentOrderCommRate,
                                                 CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQrySecAgentTradingAccount(CThostFtdcTradingAccountField *pTradingAccount, CThostFtdcRspInfoField *pRspInfo,
                                                int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQrySecAgentCheckMode(CThostFtdcSecAgentCheckModeField *pSecAgentCheckMode, CThostFtdcRspInfoField *pRspInfo,
                                           int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQrySecAgentTradeInfo(CThostFtdcSecAgentTradeInfoField *pSecAgentTradeInfo, CThostFtdcRspInfoField *pRspInfo,
                                           int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQryOptionInstrTradeCost(CThostFtdcOptionInstrTradeCostField *pOptionInstrTradeCost, CThostFtdcRspInfoField *pRspInfo,
                                              int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQryOptionInstrCommRate(CThostFtdcOptionInstrCommRateField *pOptionInstrCommRate, CThostFtdcRspInfoField *pRspInfo,
                                             int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQryExecOrder(CThostFtdcExecOrderField *pExecOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    ...
    if (pExecOrder) {
        ...
        uBEE::gb18030_to_utf8(pExecOrder->StatusMsg, ErrMsg1, 1024);
        printf("\tStatusMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnRspQryForQuote(CThostFtdcForQuoteField *pForQuote, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    ...
    if (pForQuote) {
        ...
        uBEE::gb18030_to_utf8(pForQuote->StatusMsg, ErrMsg1, 1024);
        printf("\tStatusMsg [%s]\n", ErrMsg1);
        // printf("\tStatusMsg [%s]\n", pForQuote->StatusMsg);
...
void CTraderSpi::OnRspQryQuote(CThostFtdcQuoteField *pQuote, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    ...
    if (pQuote) {
        ...
        uBEE::gb18030_to_utf8(pQuote->StatusMsg, ErrMsg1, 1024);
        printf("\tStatusMsg [%s]\n", ErrMsg1);
        // printf("\tStatusMsg [%s]\n", pQuote->StatusMsg);
        printf("\tActiveUserID [%s]\n", pQuote->ActiveUserID);
        printf("\tAskOrderRef [%s]\n", pQuote->AskOrderRef);
...
void CTraderSpi::OnRspQryOptionSelfClose(CThostFtdcOptionSelfCloseField *pOptionSelfClose, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                         bool bIsLast) {
    ...
    if (pOptionSelfClose) {
        ...
        uBEE::gb18030_to_utf8(pOptionSelfClose->StatusMsg, ErrMsg1, 1024);
        printf("\tStatusMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnRspQryInvestUnit(CThostFtdcInvestUnitField *pInvestUnit, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                    bool bIsLast) {
...
void CTraderSpi::OnRspQryCombInstrumentGuard(CThostFtdcCombInstrumentGuardField *pCombInstrumentGuard, CThostFtdcRspInfoField *pRspInfo,
                                             int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQryCombAction(CThostFtdcCombActionField *pCombAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                    bool bIsLast) {
    ...
    if (pCombAction) {
        ...
        uBEE::gb18030_to_utf8(pCombAction->StatusMsg, ErrMsg1, 1024);
        printf("\tStatusMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnRspQryTransferSerial(CThostFtdcTransferSerialField *pTransferSerial, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                        bool bIsLast) {
    ...
    if (pTransferSerial) {
        ...
        uBEE::gb18030_to_utf8(pTransferSerial->ErrorMsg, ErrMsg1, 1024);
        printf("\tErrorMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnRspQryAccountregister(CThostFtdcAccountregisterField *pAccountregister, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                         bool bIsLast) {
...
void CTraderSpi::OnRtnOrder(CThostFtdcOrderField *pOrder) {
    ...
    printf("</OnRtnOrder>\n");
    if (OrderCount > 3 && pOrder->OrderStatus == '3') {
        printf("\t 在队列中未成交的笔数超过10笔，请注意交易风险！\n");
    }
};
...
void CTraderSpi::OnErrRtnOrderAction(CThostFtdcOrderActionField *pOrderAction, CThostFtdcRspInfoField *pRspInfo) {
    ...
    if (pOrderAction) {
        ...
        printf("\tUserID [%s]\n", pOrderAction->UserID);
        uBEE::gb18030_to_utf8(pOrderAction->StatusMsg, ErrMsg1, 1024);
        printf("\tStatusMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnRtnErrorConditionalOrder(CThostFtdcErrorConditionalOrderField *pErrorConditionalOrder) {
    ...
    if (pErrorConditionalOrder) {
        ...
        uBEE::gb18030_to_utf8(pErrorConditionalOrder->StatusMsg, ErrMsg1, 1024);
        printf("\tStatusMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnErrRtnExecOrderAction(CThostFtdcExecOrderActionField *pExecOrderAction, CThostFtdcRspInfoField *pRspInfo) {
    ...
    if (pExecOrderAction) {
        ...
        uBEE::gb18030_to_utf8(pExecOrderAction->StatusMsg, ErrMsg1, 1024);
        printf("\tStatusMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnErrRtnQuoteAction(CThostFtdcQuoteActionField *pQuoteAction, CThostFtdcRspInfoField *pRspInfo) {
    ...
    if (pQuoteAction) {
        ...
        printf("\tUserID [%s]\n", pQuoteAction->UserID);
        uBEE::gb18030_to_utf8(pQuoteAction->StatusMsg, ErrMsg1, 1024);
        printf("\tStatusMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnErrRtnBatchOrderAction(CThostFtdcBatchOrderActionField *pBatchOrderAction, CThostFtdcRspInfoField *pRspInfo) {
    ...
    if (pBatchOrderAction) {
        ...
        uBEE::gb18030_to_utf8(pBatchOrderAction->StatusMsg, ErrMsg1, 1024);
        printf("\tStatusMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnErrRtnOptionSelfCloseInsert(CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose,
...
void CTraderSpi::OnErrRtnOptionSelfCloseAction(CThostFtdcOptionSelfCloseActionField *pOptionSelfCloseAction,
                                               CThostFtdcRspInfoField *pRspInfo) {
    ...
    if (pOptionSelfCloseAction) {
        ...
        uBEE::gb18030_to_utf8(pOptionSelfCloseAction->StatusMsg, ErrMsg1, 1024);
        printf("\tStatusMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnRspQryContractBank(CThostFtdcContractBankField *pContractBank, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                      bool bIsLast) {
...
void CTraderSpi::OnRspQryParkedOrder(CThostFtdcParkedOrderField *pParkedOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                     bool bIsLast) {
...
void CTraderSpi::OnRspQryParkedOrderAction(CThostFtdcParkedOrderActionField *pParkedOrderAction, CThostFtdcRspInfoField *pRspInfo,
                                           int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQryTradingNotice(CThostFtdcTradingNoticeField *pTradingNotice, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                       bool bIsLast) {
...
void CTraderSpi::OnRspQryBrokerTradingParams(CThostFtdcBrokerTradingParamsField *pBrokerTradingParams, CThostFtdcRspInfoField *pRspInfo,
                                             int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQryBrokerTradingAlgos(CThostFtdcBrokerTradingAlgosField *pBrokerTradingAlgos, CThostFtdcRspInfoField *pRspInfo,
                                            int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRspQueryCFMMCTradingAccountToken(CThostFtdcQueryCFMMCTradingAccountTokenField *pQueryCFMMCTradingAccountToken,
                                                    CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRtnFromBankToFutureByBank(CThostFtdcRspTransferField *pRspTransfer) {
    ...
    if (pRspTransfer) {
        ...
        printf("\tOperNo [%s]\n", pRspTransfer->OperNo);
        uBEE::gb18030_to_utf8(pRspTransfer->ErrorMsg, ErrMsg1, 1024);
        printf("\tErrorMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnRtnRepealFromBankToFutureByBank(CThostFtdcRspRepealField *pRspRepeal) {
    ...
    if (pRspRepeal) {
        ...
        printf("\tOperNo [%s]\n", pRspRepeal->OperNo);
        uBEE::gb18030_to_utf8(pRspRepeal->ErrorMsg, ErrMsg1, 1024);
        printf("\tErrorMsg [%s]\n", ErrMsg1);
        // printf("\tErrorMsg [%s]\n", pRspRepeal->ErrorMsg);
...
void CTraderSpi::OnRtnQueryBankBalanceByFuture(CThostFtdcNotifyQueryAccountField *pNotifyQueryAccount) {
    ...
    if (pNotifyQueryAccount) {
        ...
        uBEE::gb18030_to_utf8(pNotifyQueryAccount->ErrorMsg, ErrMsg1, 1024);
        printf("\tErrorMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnRspFromBankToFutureByFuture(CThostFtdcReqTransferField *pReqTransfer, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                               bool bIsLast) {
...
void CTraderSpi::OnRspFromFutureToBankByFuture(CThostFtdcReqTransferField *pReqTransfer, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                               bool bIsLast) {
...
void CTraderSpi::OnRspQueryBankAccountMoneyByFuture(CThostFtdcReqQueryAccountField *pReqQueryAccount, CThostFtdcRspInfoField *pRspInfo,
                                                    int nRequestID, bool bIsLast) {
...
void CTraderSpi::OnRtnOpenAccountByBank(CThostFtdcOpenAccountField *pOpenAccount) {
    ...
    if (pOpenAccount) {
        ...
        printf("\tOperNo [%s]\n", pOpenAccount->OperNo);
        printf("\tUserID [%s]\n", pOpenAccount->UserID);
        uBEE::gb18030_to_utf8(pOpenAccount->ErrorMsg, ErrMsg1, 1024);
        printf("\tErrorMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnRtnCancelAccountByBank(CThostFtdcCancelAccountField *pCancelAccount) {
    ...
    if (pCancelAccount) {
        ...
        uBEE::gb18030_to_utf8(pCancelAccount->ErrorMsg, ErrMsg1, 1024);
        printf("\tErrorMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnRtnChangeAccountByBank(CThostFtdcChangeAccountField *pChangeAccount) {
    ...
    if (pChangeAccount) {
        ...
        uBEE::gb18030_to_utf8(pChangeAccount->ErrorMsg, ErrMsg1, 1024);
        printf("\tErrorMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnRspQryClassifiedInstrument(CThostFtdcInstrumentField *pInstrument, CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                                              bool bIsLast) {
    printf("<OnRspQryClassifiedInstrument>\n");
    if (pInstrument) {
        printf("\treserve1 [%s]\n", pInstrument->reserve1);
        printf("\tExchangeID [%s]\n", pInstrument->ExchangeID);
        printf("\tInstrumentName [%s]\n", pInstrument->InstrumentName);
...
void CTraderSpi::OnRspQryCombPromotionParam(CThostFtdcCombPromotionParamField *pCombPromotionParam, CThostFtdcRspInfoField *pRspInfo,
                                            int nRequestID, bool bIsLast) {
    printf("<OnRspQryCombPromotionParam>\n");
    if (pCombPromotionParam) {
        printf("\tExchangeID [%s]\n", pCombPromotionParam->ExchangeID);
        printf("\tInstrumentID [%s]\n", pCombPromotionParam->InstrumentID);
        printf("\tCombHedgeFlag [%s]\n", pCombPromotionParam->CombHedgeFlag);
        printf("\tXparameter [%.8lf]\n", pCombPromotionParam->Xparameter);
    }
    if (pRspInfo) {
        uBEE::gb18030_to_utf8(pRspInfo->ErrorMsg, ErrMsg1, 1024);
        printf("\tErrorMsg [%s]\n", ErrMsg1);
...
void CTraderSpi::OnRspQryRiskSettleInvstPosition(CThostFtdcRiskSettleInvstPositionField *pRiskSettleInvstPosition,
                                                 CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    printf("<OnRspQryRiskSettleInvstPosition>\n");
...
void CTraderSpi::OnRspQryRiskSettleProductStatus(CThostFtdcRiskSettleProductStatusField *pRiskSettleProductStatus,
                                                 CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    printf("<OnRspQryRiskSettleProductStatus>\n");
    if (pRiskSettleProductStatus) {
        printf("\tExchangeID [%s]\n", pRiskSettleProductStatus->ExchangeID);
        printf("\tProductID [%s]\n", pRiskSettleProductStatus->ProductID);
        printf("\tProductStatus [%c]\n", pRiskSettleProductStatus->ProductStatus);
    }
    if (pRspInfo) {
        uBEE::gb18030_to_utf8(pRspInfo->ErrorMsg, ErrMsg1, 1024);
        printf("\tErrorMsg [%s]\n", ErrMsg1);
