...
template <int... N> class IND_BOLL : public OhlcvSerial<N...> {
  public:
    int N1{7};
  ...
  public:
    IND_BOLL(int n = 7) : N1(n) {
        std::cout << "BBB IND_BOLL construction !! " << std::endl;
        PLOT(rsi, 0);
        std::cout << "EEE IND_BOLL construction !! " << std::endl;
    };
    ~IND_BOLL(){};
    void run() {
